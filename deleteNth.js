...
console.log("expected: [1,2,3,1,2,3]", deleteNth([1,2,3,1,2,1,2,3], 2));
console.log("expected: [20,37,21]", deleteNth([20,37,20,21], 1));
console.log("expected:[1, 1, 3, 3, 7, 2, 2, 2]",deleteNth([1,1,3,3,7,2,2,2,2], 3));
